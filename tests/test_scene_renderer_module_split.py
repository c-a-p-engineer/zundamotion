...
def test_scene_renderer_public_facade_keeps_internal_responsibilities() -> None:
    method_modules = {
        ...
        "_escape_overlay_expr": "scene_fast_path_character",
        "_resolve_char_base_image": "scene_fast_path_character",
        "_extract_simple_character_state": "scene_fast_path_character",
        "_character_signature": "scene_fast_path_character",
        "_compute_global_char_position": "scene_fast_path_character",
        "_can_use_simple_scene_fast_path": "scene_fast_path_eligibility",
        "_build_simple_scene_fast_plan": "scene_fast_path_plan",
        "_build_simple_scene_fast_command": "scene_fast_path_graph",
        "_render_simple_scene_fast": "scene_fast_path_executor",
